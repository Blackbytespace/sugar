...
find "$SUGAR_ROOT" -name "*.test.ts" -exec sed -i '' \
...
# Convert 3-level deep shared imports
find "$SUGAR_ROOT" -name "*.ts" ! -name "_exports.ts" -exec sed -i '' \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/string/[^']*\.js';|import \1 from '@blackbyte/sugar/string';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/crypto/[^']*\.js';|import \1 from '@blackbyte/sugar/crypto';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/math/[^']*\.js';|import \1 from '@blackbyte/sugar/math';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/datetime/[^']*\.js';|import \1 from '@blackbyte/sugar/datetime';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/array/[^']*\.js';|import \1 from '@blackbyte/sugar/array';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/object/[^']*\.js';|import \1 from '@blackbyte/sugar/object';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/is/[^']*\.js';|import \1 from '@blackbyte/sugar/is';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/html/[^']*\.js';|import \1 from '@blackbyte/sugar/html';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/css/[^']*\.js';|import \1 from '@blackbyte/sugar/css';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/convert/[^']*\.js';|import \1 from '@blackbyte/sugar/convert';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./\.\./shared/easing/[^']*\.js';|import \1 from '@blackbyte/sugar/easing';|g" \
  {} \;

# Convert 2-level shared imports
find "$SUGAR_ROOT" -name "*.ts" ! -name "_exports.ts" -exec sed -i '' \
  -e "s|import \([^ ]*\) from '\.\./\.\./shared/string/[^']*\.js';|import \1 from '@blackbyte/sugar/string';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./shared/crypto/[^']*\.js';|import \1 from '@blackbyte/sugar/crypto';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./shared/math/[^']*\.js';|import \1 from '@blackbyte/sugar/math';|g" \
...
# Convert cross-platform imports within js/node  
find "$SUGAR_ROOT" -name "*.ts" ! -name "_exports.ts" -exec sed -i '' \
  -e "s|import \([^ ]*\) from '\.\./\.\./is/[^']*\.js';|import \1 from '@blackbyte/sugar/is';|g" \
  -e "s|import \([^ ]*\) from '\.\./\.\./string/[^']*\.js';|import \1 from '@blackbyte/sugar/string';|g" \
  -e "s|import \([^ ]*\) from '\.\./package/[^']*\.js';|import \1 from '@blackbyte/sugar/package';|g" \
  -e "s|import \([^ ]*\) from '\.\./fs/[^']*\.js';|import \1 from '@blackbyte/sugar/fs';|g" \
  {} \;
