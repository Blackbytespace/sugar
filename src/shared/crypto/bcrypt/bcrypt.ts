...
export default {
   ...
   * @author         Olivier Bossel <olivier.bossel@gmail.com> (https://blackbyte.space)
   */
  encrypt: function (message: any, saltRounds: number = 10): string {
   ...
   * @author         Olivier Bossel <olivier.bossel@gmail.com> (https://blackbyte.space)
   */
  compareSync: function (message: any, hash: string): boolean {
    if (typeof message !== 'string') message = String(message);
   ...
   * @author         Olivier Bossel <olivier.bossel@gmail.com> (https://blackbyte.space)
   */
  compare: function (message: any, hash: string): Promise<boolean> {
    if (typeof message !== 'string') message = String(message);
