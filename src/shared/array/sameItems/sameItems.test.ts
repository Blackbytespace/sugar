...
describe('shared.array.sameItems', () => {
  it('should return items present in both arrays', () => {
  ...
  it('should handle multiple arrays', () => {
    ...
    const result = sameItems(array1, array2, array3);
  ...
  it('should handle objects with hash comparison enabled', () => {
    ...
    const result = sameItems(array1, array2, { hash: true });
  ...
  it('should handle objects with reference comparison only', () => {
    ...
    const result = sameItems(array1, array2, { hash: false, references: true });
  ...
  it('should work with settings object passed', () => {
    const array1 = [1, 2, 3];
    const array2 = [2, 3, 4];
    const result = sameItems(array1, array2, { references: true, hash: true });
    expect(result).toEqual([2, 3]);
  });

  it('should handle single array', () => {
    const array1 = [1, 2, 3];
    const result = sameItems(array1);
    expect(result).toEqual([]); // no second array to compare with
  });
  ...
  it('should ignore non-array arguments except settings object', () => {
    const array1 = [1, 2, 3];
    const array2 = [2, 3, 4];
    const result = sameItems(array1, 'not-array', array2, 42);
    expect(result).toEqual([2, 3]);
  });
