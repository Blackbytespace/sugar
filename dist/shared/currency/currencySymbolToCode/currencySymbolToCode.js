 ...
 */
export default function currencySymbolToCode(symbol) {
    var _a;
    // clean passed symbol
    symbol = symbol.trim();
    // @ts-ignore
    ...
    // return the symbol
    return ((_a = Object.keys(symbolMap).find((key) => symbolMap[key] === symbol)) !== null && _a !== void 0 ? _a : '').toUpperCase();
}
//# sourceMappingURL=currencySymbolToCode.js.map